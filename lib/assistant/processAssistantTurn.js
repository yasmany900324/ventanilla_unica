  ...
  if (effectiveCommand === "open_incident_correction_menu") {
    ...
    if (
      ...
      return buildAssistantTurnResult({
        ...
        locale: effectiveLocale,
        replyText:
          "Cuando lleguemos al resumen final del reporte vas a poder corregir los datos solicitados desde «Corregir datos».",
        snapshot,
        actionOptions: [],
    ...
    return buildAssistantTurnResult({
      ...
      snapshot,
      actionOptions: buildIncidentCorrectionMenuActionOptions(snapshot.collectedData),
