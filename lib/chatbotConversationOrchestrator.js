...
export function buildQuestionForStep({
  ...
  if (step === CHATBOT_CURRENT_STEPS.LOCATION) {
    fallbackText = lowConfidence
      ? "No me quedo clara la ubicacion. Indicame la direccion, una referencia cercana o usa tu ubicacion actual."
      : "Indicame la direccion, una referencia cercana o usa tu ubicacion actual.";
    ...
    fallbackText = lowConfidence
      ? "No logre interpretar el nivel de riesgo. Ahora indicame si es alto, medio o bajo."
      : "Ahora indicame el nivel de riesgo: alto, medio o bajo.";
