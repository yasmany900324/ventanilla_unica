...
export function buildIncidentResumeReply(_collectedData) {
  return "Listo para registrar la incidencia. Revisá los datos y tocá «Confirmar y crear incidencia», o editá lo que necesites.";
}
