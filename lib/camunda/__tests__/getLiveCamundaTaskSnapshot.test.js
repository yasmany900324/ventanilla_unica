...
describe("getLiveCamundaTaskSnapshot", () => {
  ...
  it("normaliza id de tarea activa y devuelve acciones operativas", async () => {
    mocks.searchCamundaUserTasks.mockResolvedValueOnce([
      {
    ...
    expect(mocks.searchCamundaUserTasks).toHaveBeenCalledTimes(1);
    expect(mocks.searchCamundaUserTasks).toHaveBeenCalledWith({
